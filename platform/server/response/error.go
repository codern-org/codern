...
var DomainErrCodeToHttpStatus = map[int]int{
	...
	errs.ErrUpdateWorkspaceParticipant: fiber.StatusInternalServerError,
	errs.ErrDeleteWorkspaceParticipant: fiber.StatusInternalServerError,
	errs.ErrGetRole:                    fiber.StatusInternalServerError,
	errs.ErrInvalidRole:                fiber.StatusBadRequest,
	errs.ErrListWorkspaceParticipant:   fiber.StatusInternalServerError,
	errs.ErrGetScoreboard:              fiber.StatusInternalServerError,
	errs.ErrCreateWorkspace:            fiber.StatusInternalServerError,
	errs.ErrUpdateWorkspace:            fiber.StatusInternalServerError,
	errs.ErrDeleteWorkspace:            fiber.StatusInternalServerError,
